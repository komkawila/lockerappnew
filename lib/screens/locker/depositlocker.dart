...
class _DepositlockerScreenState extends State<DepositlockerScreen> {
            ...
            ? Column(
                ...
                children: [
                  ...
                  PinKeyboard(
                    ...
                    onChange: _onKeyboardTap,
                    onConfirm: _onKeyboardTap,
                    onBiometric: () {},
                    fontSize: 50,
                    space: 100,
                  ),
  ...
  //   final CameraController? cameraController = controller_camera;
    ...
    if (text.length < 10) {
      ...
      if (text.length == 10) {
        ...
        if (isUser == true) {
          ...
          // print(takePicture());
          // await takePicture().then((value) => print('getimage ==> $value'));
